...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-20 transition-all ease-in-out ${isScrolled ? "bg-white shadow-lg" : ""}`}
    >
      <div
      ...
      >
        <p className="text-white/80 hidden md:block">
          Boost your personal productivity with OpusList
        </p>
      ...
      <div
        className={`transition-all duration-500 ease-in-out ${isScrolled ? "py-3" : "py-5"}`}
      >
        <div className="container">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Image src={Logo} alt="OpusList Logo" height={40} width={40} />
              <span className="text-xl font-bold px-1 text-[#00313A]">
                OpusList
              </span>
            </div>
